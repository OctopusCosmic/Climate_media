...
def main():
    ...
    for link in article_links:
        ...
        # get Title/Author/Publication title to append into titles_text list
        titles = driver.find_elements_by_class_name("display_record_indexing_fieldname")
        titles_text = []
        for title in titles:
            titles_text.append(title.text)

        # get Title/Author/Publication content to append into contents_text list
        contents = driver.find_elements_by_class_name("display_record_indexing_data")
        contents_text = []
        ...
        df = add_info(row, df, titles_text, contents_text, count, keyword1)
